 ...
 * @author BirenDesai
 */
public class AgeingXLSReport extends XLSReport {

    private final ReportBean bean;
    private OutstandingService service;

    public AgeingXLSReport(HttpServletResponse response, ReportBean vo, OutstandingService service) {
    ...
    public void createHeader() {
        ...
        if (null != bean.getParam10()) {
            switch (bean.getParam10()) {
                case "PARTYSUMMARY": {
                    oar = new Object[]{"", "PARTY", "CREDIT PERIOD", "0-15", "16-30", "31-60", "61-90", "91-180",
                        "181-999", "TOTAL"};
                    break;
                }
                case "PARTYDETAIL": {
