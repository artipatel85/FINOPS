    ...
    public static String writeUCMpdf(String blNo, BLBean blBean, JdbcTemplate jdbcTemplate) {
        ...
        try {
            ...
            if (flag_data) {
                ...
                String sf = blBean.getCompanyName();
                ...
                String tel = blBean.getCompanyTel();
                String fax = blBean.getCompanyFax();
                String email = blBean.getCompanyEmail();
                String url = blBean.getCompanyUrl();

                Document document = new Document(PageSize.A4, 30, 30, 30, 130);
                ...
                float[] shipheadwidths = {30, 70};

                PdfPTable headdatatab = new PdfPTable(6);
                PdfPTable containerdatatab = new PdfPTable(6);

                PdfPCell hdatacell = new PdfPCell(new Phrase("", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                ...
                hdatacell = new PdfPCell(new Phrase("", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                hdatacell.setHorizontalAlignment(0);
                hdatacell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.TOP | Rectangle.BOTTOM);
                headdatatab.addCell(hdatacell);

                hdatacell = new PdfPCell(new Phrase("SAID TO CONTAIN", new Font(Font.HELVETICA, 10, Font.NORMAL)));
                hdatacell.setHorizontalAlignment(0);
                hdatacell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.TOP | Rectangle.BOTTOM);
                headdatatab.addCell(hdatacell);
                ...
                int totcount = 0;
                while (rssix.next()) {
                    netWeight = ApplicationUtil.checkForNull(rssix.getString("ACTUAL_KGS"));
                ...
                while (rsfour.next()) {
                    ...
                    hdatacell = new PdfPCell(new Phrase("", new Font(Font.COURIER, 9, Font.NORMAL)));
                    hdatacell.setHorizontalAlignment(0);
                    hdatacell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.TOP | Rectangle.BOTTOM);
                    headdatatab.addCell(hdatacell);
                    ...
                    hdatacell = new PdfPCell(new Phrase(netWeight, new Font(Font.COURIER, 9, Font.NORMAL)));
                    hdatacell.setHorizontalAlignment(0);
                    hdatacell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.TOP | Rectangle.BOTTOM);
                    headdatatab.addCell(hdatacell);

                    hdatacell = new PdfPCell(new Phrase(gross, new Font(Font.COURIER, 9, Font.NORMAL)));
                    hdatacell.setHorizontalAlignment(0);
                    hdatacell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.TOP | Rectangle.BOTTOM);
                    headdatatab.addCell(hdatacell);

                    hdatacell = new PdfPCell(new Phrase(cbmw, new Font(Font.COURIER, 9, Font.NORMAL)));
                    hdatacell.setHorizontalAlignment(0);
                    hdatacell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.TOP | Rectangle.BOTTOM);
                    headdatatab.addCell(hdatacell);
                ...
                String cargo = ApplicationUtil.checkForNull(rs.getString("CARGO_RECEIVE_DATE"));
                ...
                PdfPCell hcell = new PdfPCell(new Phrase("Marks & Numbers", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                hcell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM);
                hcell.setHorizontalAlignment(0);
                hcell.setBackgroundColor(Color.LIGHT_GRAY);
                headtab.addCell(hcell);

                hcell = new PdfPCell(new Phrase("No and kind of packages", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                hcell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM);
                hcell.setHorizontalAlignment(0);
                hcell.setBackgroundColor(Color.LIGHT_GRAY);
                headtab.addCell(hcell);

                hcell = new PdfPCell(new Phrase("Description of goods", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                hcell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM);
                hcell.setHorizontalAlignment(0);
                hcell.setColspan(1);
                hcell.setBackgroundColor(Color.LIGHT_GRAY);
                ...
                hcell = new PdfPCell(new Phrase("Net weight", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                hcell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM);
                hcell.setHorizontalAlignment(2);
                hcell.setBackgroundColor(Color.LIGHT_GRAY);
                headtab.addCell(hcell);

                hcell = new PdfPCell(new Phrase("Gross weight", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                hcell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM);
                hcell.setHorizontalAlignment(2);
                hcell.setBackgroundColor(Color.LIGHT_GRAY);
                hcell.setColspan(1);
                ...
                hcell = new PdfPCell(new Phrase("Measurment", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                hcell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM);
                hcell.setHorizontalAlignment(2);
                hcell.setBackgroundColor(Color.LIGHT_GRAY);
                hcell.setColspan(1);
                ...
                final int h1widths[] = {20, 30, 20, 30};
                class PageEvents extends PdfPageEventHelper {
                    ...
                    public void onStartPage(PdfWriter writer, Document document) {
                        ...
                        if (document.getPageNumber() > 1) {
                            ...
                            hcell = new PdfPCell(new Phrase(document.getPageNumber() - 1 + "", new Font(Font.COURIER, 9, Font.NORMAL)));
                            hcell.setHorizontalAlignment(0);
                            hcell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.TOP | Rectangle.BOTTOM);
                            headtab1.addCell(hcell);
                    ...
                    public void onEndPage(PdfWriter writer, Document document) {
                        ...
                        if (document.getPageNumber() > 1) {
                            ...
                            pagenocell = new PdfPCell(new Phrase(blBean.getUserId(), new Font(Font.HELVETICA, 8, Font.NORMAL)));
                            pagenocell.disableBorderSide(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM);
                            pagenocell.setHorizontalAlignment(0);
                            pageno.addCell(pagenocell);
                ...
                PdfPTable shipperhead = new PdfPTable(1);

                PdfPCell shipcell = new PdfPCell(new Phrase("Shipper\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.setBackgroundColor(Color.lightGray);
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipperhead.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(shprDetails, new Font(Font.COURIER, 9, Font.NORMAL)));
                ...
                shipcell = new PdfPCell(new Phrase(cneeDetails, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipcell.setMinimumHeight(60);
                shipcell.setFixedHeight(60);
                shipperhead.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("Notify Address\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.setBackgroundColor(Color.lightGray);
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipperhead.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(notifyAddress, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipcell.setMinimumHeight(60);
                shipcell.setFixedHeight(60);
                shipperhead.addCell(shipcell);
                ...
                PdfPCell sfCell = new PdfPCell(new Phrase("BL/MTD Number :\n\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                ...
                sfCell = new PdfPCell(new Phrase(billLadiniNo, new Font(Font.COURIER, 9, Font.NORMAL)));

                sfCell.disableBorderSide(Rectangle.TOP | Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM);
                sfpvtltd.addCell(sfCell);

                sfCell = new PdfPCell(new Phrase(sf + "\n", FontFactory.getFont(FontFactory.HELVETICA, 11, Font.BOLD, new Color(0x00, 0x00, 0xFF))));
                sfCell.disableBorderSide(Rectangle.BOTTOM | Rectangle.TOP);
                sfCell.setColspan(2);
                sfpvtltd.addCell(sfCell);

                sfCell = new PdfPCell(new Phrase("" + addressFormated + "Tel." + tel + "\nFax." + fax + "\n" + "Email. " + email + "\nURL. " + url, new Font(Font.COURIER, 9, Font.NORMAL)));
                sfCell.disableBorderSide(Rectangle.BOTTOM | Rectangle.TOP);
                sfCell.setColspan(2);
                sfpvtltd.addCell(sfCell);
                ...
                sfCell = new PdfPCell(new Phrase("Reg. No", new Font(Font.COURIER, 9, Font.NORMAL)));
                sfCell.disableBorderSide(Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
                sfCell.setColspan(1);
                sfpvtltd.addCell(sfCell);

                sfCell = new PdfPCell(new Phrase("MTO/DGS/935/DEC/2025", new Font(Font.COURIER, 9, Font.BOLD)));
                sfCell.disableBorderSide(Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
                sfCell.setColspan(1);
                sfpvtltd.addCell(sfCell);

                sfCell = new PdfPCell(new Phrase(contents, new Font(Font.TIMES_ROMAN, 7, Font.NORMAL)));
                sfCell.disableBorderSide(Rectangle.BOTTOM | Rectangle.TOP);
                sfCell.setColspan(2);
                sfpvtltd.addCell(sfCell);
                sfpvtltd.setWidthPercentage(100);
                sfpvtltd.setWidths(shipheadwidths);

                PdfPCell shippvtcell = new PdfPCell(sfpvtltd);
                shippvtcell.setColspan(2);
                shipper.addCell(shippvtcell);

                shipcell = new PdfPCell(new Phrase("Place of receipt\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("Port of loading\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("Means of Transport\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("Cargo Received on\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(por, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(pol, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("", new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(cargo, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("Port of discharge\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("Place of delivery\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("Ocean vessel\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase("Voyage\n", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.BOTTOM);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(pod, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(destName, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(vessel, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipper.addCell(shipcell);

                shipcell = new PdfPCell(new Phrase(voyage, new Font(Font.COURIER, 9, Font.NORMAL)));
                shipcell.disableBorderSide(Rectangle.TOP);
                shipper.addCell(shipcell);

                while (rsfive.next()) {
                    String marknostr = (String) rsfive.getString("MARK_NO");
                    String markdetstr = (String) rsfive.getString("MARK_DETAILS");
                ...
                String accord = "Particulars above furnished by consigner/consignee";

                PdfPTable pageFooter = new PdfPTable(4);
                float[] pfwidths = {25, 25, 25, 25};
                ...
                attchedCell.setMinimumHeight(380);
                ...
                try {
                    ifFits = (containerdatatab.getRows().size() > 5 || ((PdfPRow) containerdatatab.getRows().get(0)).getCells()[2].getPhrase().toString().length() > 380) ? false : true;
                }
                ...
                PdfPCell pfcell = new PdfPCell(new Phrase(accord, new Font(Font.HELVETICA, 8, Font.NORMAL)));
                pfcell.setColspan(4);
                ...
                PdfPCell pIcell = new PdfPCell(new Phrase("Freight Amount", new Font(Font.HELVETICA, 8, Font.BOLD)));
                pIcell.disableBorderSide(Rectangle.BOTTOM);
                pIcell.setColspan(1);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase("Freight payable At", new Font(Font.HELVETICA, 8, Font.BOLD)));
                pIcell.disableBorderSide(Rectangle.BOTTOM);
                pIcell.setColspan(1);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase("Number of Original BL/MTD(s)", new Font(Font.HELVETICA, 8, Font.BOLD)));
                pIcell.disableBorderSide(Rectangle.BOTTOM);
                pIcell.setColspan(1);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase("Place and date of issue", new Font(Font.HELVETICA, 8, Font.BOLD)));
                pIcell.disableBorderSide(Rectangle.BOTTOM);
                pIcell.setColspan(1);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase("", new Font(Font.COURIER, 9, Font.NORMAL)));
                pIcell.disableBorderSide(Rectangle.TOP);
                pIcell.setColspan(1);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase(payableAt, new Font(Font.COURIER, 9, Font.NORMAL)));
                pIcell.disableBorderSide(Rectangle.TOP);
                pIcell.setColspan(1);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase(original, new Font(Font.COURIER, 9, Font.NORMAL)));
                pIcell.disableBorderSide(Rectangle.TOP);
                pIcell.setColspan(1);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase(issuePlace + "," + issueDate, new Font(Font.COURIER, 9, Font.NORMAL)));
                pIcell.disableBorderSide(Rectangle.TOP);
                pIcell.setColspan(1);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase("For Delivery of Goods please apply to", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                pIcell.disableBorderSide(Rectangle.BOTTOM);
                pIcell.setColspan(2);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase("For SHIKHAR FORWARDERS PVT. LTD.", new Font(Font.HELVETICA, 8, Font.BOLD)));
                pIcell.disableBorderSide(Rectangle.BOTTOM);
                pIcell.setColspan(2);
                pageFooter.addCell(pIcell);

                pIcell = new PdfPCell(new Phrase(destAddress, new Font(Font.COURIER, 9, Font.NORMAL)));
                pIcell.disableBorderSide(Rectangle.TOP);
                pIcell.setColspan(2);
                ...
                pIcell = new PdfPCell(new Phrase("(Authorised Signatory)", new Font(Font.HELVETICA, 8, Font.BOLD)));
                pIcell.disableBorderSide(Rectangle.TOP);
                pIcell.setColspan(2);
