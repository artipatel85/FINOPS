...
<!DOCTYPE html>
<html>
    <html:form autocomplete="off" method="post" id="SalesmanForm" action="salseman.fin">
    <head>
        ...
        <script>
                $(document).ready(function () {
                    var table = $('#countryview').DataTable({
                        ajax: "adminGson.fin?param=Salesman",
                        "bJQueryUI": true,
                        deferRender: true,
                        ...
                        "aoColumns": [
                            ...
                            {"mData": "code",
                                "render": function (mData, full, row) {
                                    var link = row['code'];
                                    return '<a href="retrieveSalesman.fin?code=' + link + '">' + mData + '</a>';
                                }
