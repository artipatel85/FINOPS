...
<!DOCTYPE html>
<html>
    <html:form autocomplete="off" method="post" id="TerminalForm" action="terminal.fin">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>JSP Page</title>
         <script>
                $(document).ready(function () {
                    var table = $('#terminalview').DataTable({
                        ajax: "adminGson.fin?param=Terminal",
                        "bJQueryUI": true,
                        deferRender: true,
                        ...
                        "aoColumns": [
                            ...
                            {"mData": "code",
                                "render": function (mData, full, row) {
                                    var link = row['code'];
                                    return '<a href="retrieveTerminal.fin?code=' + link + '">' + mData + '</a>';
                                }
                ...
                $(function () {
                    $("#btnnew").on('click', function () {
                        $('#TerminalForm').attr("action", "terminal.fin");
                        $("#TerminalForm").submit();
                    });
                });
    ...
    <body>
          <header>
            ...
            <table id="terminalview" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th></th>
                        <th>TERMINAL CODE</th>
