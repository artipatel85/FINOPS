        ...
        <script>
            ...
            $("#billToName").autocomplete({
                ...
                source: function (request, response) {
                    $.getJSON("autoComplete.fin?param=INVOICE_BILLTO&type=1", {
                        term: request.term

                    }, function (result) {

                        var wordlist = ($.map(result, function (item) {
                            return {value: item.value, billTo: item.param2, billToAddress: item.param3,
                            partyAcctCode:item.param4, stateCode: item.param6, gstin: item.param8}
        ...
        <div class="comdiv">
                ...
                <table class="tablec">
                    ...
                    <tr>
                        ...
                        <td>
                            <html:input path="billtoName" class="largeXL" id="billToName"/><html:input path="partyAcctCode" class="small readonly" readonly="true" id="partyAcctCode"/>
                        </td>
                        <td>
                        ...
                        <td>
                            <html:textarea path="billtoContctDtls" id="billToAddress" class="textareaL readonly"></html:textarea>
                        </td>
                        <td>
                            BL NO
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <html:select path="billType">
                                ...
                                <html:option value="SUPPLEMENT">SUPPLEMENTARY</html:option>
                    ...
                    <tr>
                        ...
                        <td><label>EXPORT/IMPORT</label></td>
                        <td>
                            <html:input path="expImp" class="smallplus readonly" readonly="true"/>
                        </td>
                        <td><label>LOCAL/FOREIGN</label></td>
                        <td>
