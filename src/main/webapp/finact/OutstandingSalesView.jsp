<%-- 
    Document   : OutstandingPartyView
    Created on : Sep 15, 2017, 11:04:57 AM
    Author     : BirenDesai
--%>
...
<html>
    <head>
        ...
        <title>OutstandingSalesView</title>
        ...
        <script>
            $(document).ready(function () {
                var table = $('#example').DataTable({
                    ...
                    "aoColumns": [
                        ...
                        {
                            "mData": "param2",
                            "render": function(mData, row){
                                var href = "javascript:viewFunction1('partyViewDetail.fin?id=" + mData + "')";
            ...
            function viewFunction1(link) {
                $("#partyview").load(encodeURI(link)).dialog("open");
            }
        ...
        <table id="example" class="display" cellspacing="0" width="100%">
            ...
            <thead>
                <tr>
                    ...
                    <td><input type='text' value='' class='filter smalltext1' data-column-index='7'></td>
                    <td><input type='text' value='' class='filter smalltext1' data-column-index='8'></td>
                    <td></td>
                </tr>
            </thead>
        </table>
