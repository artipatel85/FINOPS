    ...
    <head>
        ...
        <script>
            ...
            {   
                ...
                {
                    window.open("voucherPDFReport.fin?voucherType=PAYMENT&trxId=${voucherBean.jeHdrId}");
                }
            }
        ...
        <div class="comdiv">
            <html:form autocomplete="off" method="post" action="saveVoucher.fin" id="voucherForm" onSubmit="ShowLoading()">
                ...
                <table class="tablec" width="100%">
                    ...
                    <tr>
                        <td width="10%"><label>PAYMENT NO</label></td>
                        <td width="50%">
                            <html:input path="voucherNo" class="medium" readonly="true"/>
                            <html:hidden path="jeHdrId" />
                            <html:hidden path="voucherType" value="PAYMENT"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <html:input path="hdrAcctName" class="large" id="hdrAcctName"/>
                ...
                <table class="tablevou" id="tbl" >
                    ...
                    <c:forEach items="${command.voucherRows}" var="voucherRow" varStatus="status">
                        <tr>
                            ...
                            <td><html:input path="voucherRows[${status.index}].rowChqDt" value="${voucherRow.rowChqDt}" cssClass="smallplus datepicker_recurring_start" onchange="autoNarration(this,'${status.index}')"/></td>
