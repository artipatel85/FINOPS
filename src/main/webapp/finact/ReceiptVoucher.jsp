...
<html>
    <head>
        ...
        <script>
            ...
            {   
                ...
                {
                    window.open("voucherPDFReport.fin?voucherType=RECEIPT&trxId=${voucherBean.jeHdrId}");
                }
            }
            
            function autoNarration(src, idx){                
                var prefix = "By CH. NO. ";
                var suffix = " DATED ";
                var val = $('input[id="chqNo"]').get(idx).value;
                var dt = $('input[name="voucherRows['+idx+'].rowChqDt"]').val();
                $('textarea[id="lineRemarks"]').get(idx).value = prefix + val + suffix+dt;
            }
            ...
            function calculate(){
                ...
                $('input[name="lineTotalAmount"]').val(sum.toFixed(2));
                $('input[name="hdrTotalAmount"]').val(sum.toFixed(2));
            }
    ...
    <body>
        <div class="comdiv">
            <html:form autocomplete="off" command="voucherBean" method="post" action="saveVoucher.fin" id="voucherForm" onSubmit="ShowLoading()">
                <header>
                    RECEIPT VOUCHER
                </header>
                <table class="tablec" width="100%">
                    ...
                    <tr>
                        ...
                        <td width="50%">
                            ...
                            <html:hidden path="voucherType" value="RECEIPT"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <html:input path="hdrAcctName" class="large"/>
            ...
            <div class="rows">
                ...
                <table class="tablevou" id="tbl" >
                    ...
                    <thead>
                        <tr>
                            <c:if test="${voucherBean.jeHdrId == 0}">
                    ...
                    <c:forEach items="${command.voucherRows}" var="voucherRow" varStatus="status">
                        <tr>
                            ...
                            <td>
                                <c:if test="${voucherBean.voucherType == 'RECEIPT'}" >
                            ...
                            <td><html:input path="voucherRows[${status.index}].rowChq" value="${voucherRow.rowChq}" cssClass="smallplus" onchange="autoNarration(this,'${status.index}')" id="chqNo"/></td>
                            <td><html:input path="voucherRows[${status.index}].rowChqDt" value="${voucherRow.rowChqDt}" cssClass="smallplus datepicker_recurring_start" onchange="autoNarration(this,'${status.index}')" id="chqDate"/></td>
                            ...
                            <td><html:textarea path="voucherRows[${status.index}].rowRem" value="${voucherRow.rowRem}" cssClass="textareaL" id="lineRemarks"/></td>
