...
<!DOCTYPE html>
<html>
    <html:form id="partnerKycForm" autocomplete="off" method="post" commandName="partnerBean" action="createPartnerKYC.fin" enctype="multipart/form-data">
        <head>
            ...
            <script>
                ...
                $(function () {
                    $("#replicateBtn").on("click", function () {
                        $('#partnerKycForm').attr("action", "replicatePartnerKYC.fin");
                    ...
                    $("#promoteBtn").on("click", function () {
                        $("#action").val("PROMOTE");
                        $('#partnerKycForm').attr("action", "createPartnerKYC.fin");
                        $("#partnerKycForm").submit();
                    });
                });
                ...
                $(document).ready(function () {
                    ...
                    $("#partnerKycForm").validate({
                        ...
                        messages: {
                            ...
                            telNo: '<div class="tool">* field is required.</div>',
        ...
        <body>
            <div class="comdiv">
                ...
                <table class="tablec">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <rbac:rbac formId="1145" pattern="(.)\\|(Y)\\|(Y)\\|(.)\\|(.)\\|(.)\\|(.)">
                                <c:if test="${partnerBean.action == 'UPDATE'}">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <html:hidden path="id"/>
                            <html:hidden path="action" id="action"/>
                    ...
                    <tr>
                        ...
                        <td><html:input path="kycNote" class="medium"/></td>
                ...
                <table class="tablee">
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <a target="new" href="kycAttachment.fin?kycId=${partnerBean.id}&index=1&partnerName=${partnerBean.description1}&fileName=${partnerBean.attachment1FileName}"><c:out value="${partnerBean.attachment1FileName}"/></a>
                            </label>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <label>
                                <a target="new" href="kycAttachment.fin?kycId=${partnerBean.id}&index=2&partnerName=${partnerBean.description1}&fileName=${partnerBean.attachment2FileName}"><c:out value="${partnerBean.attachment2FileName}"/></a>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <a target="new" href="kycAttachment.fin?kycId=${partnerBean.id}&index=3&partnerName=${partnerBean.description1}&fileName=${partnerBean.attachment3FileName}"><c:out value="${partnerBean.attachment3FileName}"/></a>
                        </td>
                        <td>
                            <label for="file1">Attachment 4</label>
                            <a target="new" href="kycAttachment.fin?kycId=${partnerBean.id}&index=4&partnerName=${partnerBean.description1}&fileName=${partnerBean.attachment4FileName}"><c:out value="${partnerBean.attachment4FileName}"/></a>
                        </td>
                        <td>
                ...
                <table class="tablefooter">
                    <tr>
                        <c:if test="${partnerBean.partnerCode == null  && partnerBean.id == 0}">
                        ...
                        <c:if test="${(partnerBean.partnerCode == null || partnerBean.partnerCode == '') && partnerBean.id > 0}">
                            ...
                            <td><button type="submit" class="finbutton" id="promoteBtn">Promote</button></td>
                        </c:if>

                        <c:if test="${partnerBean.partnerCode != null && partnerBean.partnerAcctCode == 0}">
                            <rbac:rbac formId="1145" pattern="(.)\\|(Y)\\|(Y)\\|(.)\\|(.)\\|(.)\\|(.)">
